...
public class Installer {
	...
	// 需要交个容器管理
	public void install() {
		Session session = sessionFactory.getCurrentSession();// 获取容器中session
		// 保存超级管理员
		User user = new User();
		user.setLoginName("admin");
		user.setPassword("超级管理员");
		...
		menu4 = new Privilege("待我申请", "/flow_myTaskList", menu);
